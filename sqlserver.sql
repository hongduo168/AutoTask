...
IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[QRTZ_SETTING]') AND OBJECTPROPERTY(id, N'ISUSERTABLE') = 1)
DROP TABLE [dbo].[QRTZ_SETTING]
GO
...
CREATE TABLE [QRTZ_SETTING] (
  ...
  [TRIGGER_GROUP] [NVARCHAR] (150)  NOT NULL ,
  [CRON_EXPRESSION] [NVARCHAR] (120)  NOT NULL ,
  [START_TIME] [NVARCHAR] (120)  NOT NULL ,
  [END_TIME] [NVARCHAR] (120)  NOT NULL ,
  [HOST] [NVARCHAR] (120)  NOT NULL ,
)

ALTER TABLE [QRTZ_SETTING] ADD [REQUESTHOST] [NVARCHAR] (255) DEFAULT('') NOT NULL;
ALTER TABLE [QRTZ_SETTING] ADD [REQUESTPATH] [NVARCHAR] (255) DEFAULT('')  NOT NULL;
GO
